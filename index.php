...
<body>
  <div class="login-shell">
    <div class="login-topleft">
      ...
      <div class="brand-mark"><?= brand_mark_svg(30) ?><span class="wordmark"><?= e(APP_NAME) ?></span></div>
      <p class="login-tagline"><?= e(APP_FULL_NAME) ?> &mdash; <em>layanan cuti, tanpa antre.</em></p>
    </div>
